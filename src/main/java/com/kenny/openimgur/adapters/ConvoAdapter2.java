 ...
 */
public class ConvoAdapter2 extends BaseRecyclerAdapter<ImgurConvo> {
    ...
    public ConvoAdapter2(Context context, List<ImgurConvo> convos, View.OnClickListener clickListener, View.OnLongClickListener longClickListener) {
